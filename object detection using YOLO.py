...
classNames=["person", "bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck", "boat", "traffic light", "fire hydrant", "stop sign", "parking meter", "bench", "bird", "cat",
            ...
            "mouse", "remote", "keyboard", "cell phone", "microwave", "oven", "toaster", "sink", "refrigerator", "book", "clock", "vase", "scissors", "teddy bear", "hair drier",
            "toothbrush"]
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if currentClass=="car" or currentClass=="person" or currentClass=="cell phone" or currentClass=="laptop":
